...
def home(request):
    ...
    # City='Bhopal'
    # return render(request,'home.html',{'nm':Name,'quali':Qualification,'ct':City})
    # data = {
    #     'nm':'Neeraj',
    #     'quali':'M.Tech.',
    #     'ct':'Bhopal'
...
#     Qualification='M.Tech'
#     City='Bhopal'
#     return render(request,'home.html',context={'nm':Name,'quali':Qualification,'ct':City})
...
#     return render(request,'home1.html',students)


# def filter_datetime(request):
#     d = datetime.now()
#     return render(request,'dateTime.html',{'dt':d})
...
#         'z':45.4600
#     }
#     return render(request,'float.html',data)

# def if_tag(request):
#     return render(request,'if_tag.html',{'name':'Neeraj','st':5, 'languages':['python','JavaScript','Node','PHP']})
